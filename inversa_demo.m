%% 8 pisibles soluciones de cinematica inversa


%instanciar el robot asignado
BX200X

%Definir una posicion aletoria para encontrar
posicion_def = [pi-pi/12,(pi/2)+(pi/6.25),pi/5,pi,(pi/2)+(pi/4),0];
%M6=dircin(r2,posicion_def);%matriz homogenea de transformacion indica la poisicion y rotacion de la herramienta respecto de la base
M6=[eye(3),[2500;0;2018];0 0 0 1];

p_6=pos(M6);%posicion deseada de la herramienta

z_6=M6(1:3,3); %proyecciones de z de la herramienta
...
rot_3_6_arriba=inv(rot_0_3_arriba)*rot_6;%matriz de rotacion r de 3 a 6
...
q_invK_codoabajo2=[q1_1,q_2_2,q_3_2,q_4_2_abajo,q_5_2_abajo,q_6_2_abajo];
 ...
 inigraf
 crearob(r2,q_invK_codoarriba)
%  crearob(r2,q_invK_codoarriba2')
 crearob(r2,q_invK_codoabajo')
%  crearob(r2,q_invK_codoabajo2')
...
crearob(r2,posicion_def')
crearob(r2,q_invK_codoarriba_or2')
crearob(r2,q_invK_codoarriba_or2_2')
crearob(r2,q_invK_codoabajo_or2')
crearob(r2,q_invK_codoabajo_or2_2')
